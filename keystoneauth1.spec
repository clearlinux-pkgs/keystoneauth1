...
Source0  : https://files.pythonhosted.org/packages/60/0c/0d8ed208821c40a4c55c1d206658c4c7cd69d3d041a3202feef5c0eca902/keystoneauth1-4.2.0.tar.gz
...
%prep
%setup -q -n keystoneauth1-4.2.0
cd %{_builddir}/keystoneauth1-4.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1593017242
...
cp %{_builddir}/keystoneauth1-4.2.0/LICENSE %{buildroot}/usr/share/package-licenses/keystoneauth1/3bc2515d38cf15fbffb99283a4b24e7bc6403351

...
Source0  : https://files.pythonhosted.org/packages/ba/b4/f9d85343fb7b268048bba893c20b9eaddcfe57b230a8169505cbe48107e9/keystoneauth1-4.0.0.tar.gz
...
%prep
%setup -q -n keystoneauth1-4.0.0
cd %{_builddir}/keystoneauth1-4.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585927936
...
cp %{_builddir}/keystoneauth1-4.0.0/LICENSE %{buildroot}/usr/share/package-licenses/keystoneauth1/3bc2515d38cf15fbffb99283a4b24e7bc6403351

...
Source0  : https://files.pythonhosted.org/packages/0a/5d/b13d2b6e2f64d3e3f8a83b04fe86d7577db289eb6c705cc9f1430db2214b/keystoneauth1-3.16.0.tar.gz
...
%prep
%setup -q -n keystoneauth1-3.16.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1565462110
